...
<div class="about-hero">
  ...
  <div class="about-hero-text">
    ...
    <div class="resource-stick-buttons">
      ...
      <a href="#" class="btn-store btn-store--filled">On imprimir-lo</a>
    </div>
  </div>
</div>
```
...
- Descarrega l'aplicació i comença a mesurar la mida dels fruits directament des del teu telèfon mòbil.
...
[Descarrega les imatges de prova →](../assets/app/imatges_test_app.zip){.btn-store .btn-store--outline}
:::
...
Distància (mm) des de la fruita fins a la càmera (per defecte: 250 mm)
